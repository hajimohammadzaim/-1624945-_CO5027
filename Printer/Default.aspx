...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <h1 id="title-h1">Welcome to E-online Order Printers</h1>
    <p></p>
    <h2 id="hh">"We are a group of experienced IT service and support team. 
       We set new standards in user experience & make future happen."</h2>
    <p></p>
   
    
    
<img id="logo-brand" src="Images/toner-brand-logos.167141529_std.gif" alt="image logo">
