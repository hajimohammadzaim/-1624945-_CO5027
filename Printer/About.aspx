<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Printer.About1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
  ...
  <div id="about">
    ...
    We believe that quality products will improve the way a business operates. Hence, we strive to provide the best products to small and medium enterprises (SMEs) in the private sector as well as to the local government. 
